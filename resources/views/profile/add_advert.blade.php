                                    ...
                                    <form class="row g-3 needs-validation" method="post" action="{{route('profile.store_advert')}}" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="col-12 ui search search-edition search-box">
                                            ...
                                            <div class="ui left icon input">
                                                ...
                                                <input type="text" class="form-control prompt" id="edition_name" name="edition" value="{{old('edition')}}"/>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea type="text" class="form-control" maxlength="2000" name="description">{{old('description')}}</textarea>
                                            <div class="invalid-tooltip">
                                                Поле не должно быть пустым!
                                            </div>
                                            @error('description')
