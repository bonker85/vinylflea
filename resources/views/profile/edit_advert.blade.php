                                ...
                                <div class="card-body">
                                    <form class="row g-3 needs-validation" method="post" action="{{route('profile.update_advert', $advert->id)}}" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" required name="price" placeholder="0.00" id="price" value="{{$advert->price}}">
                                            <div class="invalid-tooltip">
                                                Поле не должно быть пустым!
                                            </div>
                                            @error('price')
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea type="text" class="form-control" maxlength="1000" required name="description">{{$advert->description}}</textarea>
                                            <div class="invalid-tooltip">
                                                Поле не должно быть пустым!
                                            </div>
                                            @error('description')
