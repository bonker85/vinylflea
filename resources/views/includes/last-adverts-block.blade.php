<section class="adverts-section">
    <div class="container">
        <div class="d-flex align-items-center all-vinyl-list pt-4">
            ...
            <a href="{{route('vinyls.style', 'all')}}" class="text-uppercase text-info ms-auto btn btn-dark fs-5 rounded-3 fw-bold padding-btn">Смотреть все<i class='bx bx-chevron-right'></i></a>
        </div>
        <hr/>
