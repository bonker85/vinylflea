    ...
    <div class="container">
        <nav id="navbar_main" class="mobile-offcanvas navbar navbar-expand-lg">
                            ...
                            <div class="col-md-4">
                                <ul class="">
                                        <li class="menu-info-block ">
                                            <!--
                                            <a class="viber" href="" style="padding: 0 0 0 10px;"><img src="/images/viber.png" style="width: 20px;padding-top: 5px;"></a>
                                            <a class="telegram" href="" class="list-inline-item"><i class="bx bxl-telegram"></i></a>
                                            -->
            ...
            <div class="info-block">
                <p>
                    <a class="telegram" href="" class="list-inline-item"><i class="bx bxl-telegram"></i></a>
                    <a class="viber" href=""><img src="/images/viber.png" style="width: 25px;margin-bottom: 15px;margin-right: 5px;"></a>
